...
import com.example.vivek.recycleviewdatabasedeleteandsearch.Utils.ItemClickListener;
...
public class UserDataDisplayActivity extends AppCompatActivity implements AlertDialogHelper.AlertDialogListener, SearchView.OnQueryTextListener {
    ...
    private UserInputViewAdapter usersRecyclerAdapter;
    ...
    private void initiateObjects() {
        ...
        usersRecyclerAdapter = new UserInputViewAdapter(user_list, multiselect_list, this);
        temp_list = user_list;
        ...
        recyclerViewUsers.addOnItemTouchListener(new ItemClickListener(this, recyclerViewUsers, new ItemClickListener.OnItemClickListener() {
            @Override
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_delete:
                    alertDialogHelper.showAlertDialog("", "Контакт видалено", "DELETE", "CANCEL", 1, false);
                    return true;
                default:
                    return false;
            }
    ...
    private List<ListDataModel> filter(List<ListDataModel> models, String query) {
        ...
        usersRecyclerAdapter = new UserInputViewAdapter(filteredModelList, multiselect_list, UserDataDisplayActivity.this);
